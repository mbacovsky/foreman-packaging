...
mv %{buildroot}%{gem_instdir}/config/foreman-maintain.completion %{buildroot}%{_root_sysconfdir}/bash_completion.d/%{gem_name}
...
* Thu Aug 09 2018 Martin Bacovsky <mbacovsk@redhat.com> 0.2.6-2
